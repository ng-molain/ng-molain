...
import {FormControlSelectorDirective} from "./form-control-selector.directive";
...
export class NzFormControlsComponent implements OnInit, AfterViewInit {
  ...
  @ViewChildren(FormControlSelectorDirective) formControls!: QueryList<FormControlSelectorDirective>;
